...
export interface EmergencyNotification {
  id: string;
  type: 'emergency_created' | 'emergency_resolved' | 'emergency_escalated' | 'broadcast' | 'critical_alert' | 'vehicle_update';
  title: string;
  message: string;
...
class OptimizedRealTimeEmergencyService {
  ...
  public async broadcastVehicleUpdate(vehicleData: any): Promise<void> {
  ...
  public async broadcastVehicleOffline(vehicleId: string, routeId?: string): Promise<void> {
  ...
  public async broadcastVehicleOnline(vehicleData: any): Promise<void> {
