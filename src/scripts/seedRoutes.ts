...
const sampleRoutes = [
  {
    ...
    pricing: {
      ...
      pricePerKm: 2.0,
      discounts: [
        { type: "student" as const, percentage: 20 },
        { type: "senior" as const, percentage: 15 },
  ...
  },
  {
    ...
    pricing: {
      ...
      pricePerKm: 1.2,
      discounts: [
        { type: "student" as const, percentage: 30 },
        { type: "senior" as const, percentage: 25 },
        { type: "military" as const, percentage: 20 }
      ]
    },
    status: "active" as const
  }
...
const seedRoutes = async () => {
  try {
    ...
    let defaultFleet = await Fleet.findOne({ companyName: "National Transport Commission" });
