// src/controllers/adminAIController.ts
...
let mockTrainingJobs: TrainingJob[] = [];

// @desc    Get AI system overview and statistics
// @route   GET /api/admin/ai
// @access  Private (System Admin)
export const getAISystemOverview = async (req: Request, res: Response): Promise<void> => {
  try {
...
// @access  Private (System Admin)
export const getAIModule = async (req: Request, res: Response): Promise<void> => {
  try {
...
// @access  Private (System Admin)
export const toggleAIModule = async (req: Request, res: Response): Promise<void> => {
  try {
    const { moduleId } = req.params;
...
// @access  Private (System Admin)
export const getAllTrainingJobs = async (req: Request, res: Response): Promise<void> => {
  try {
...
// @access  Private (System Admin)
export const updateModuleConfig = async (req: Request, res: Response): Promise<void> => {
  try {
    const { moduleId } = req.params;
