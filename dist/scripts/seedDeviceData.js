...
const seedDeviceData = async () => {
    try {
        ...
        const fleetManager = await User_1.default.findOne({
        ...
        const existingDevices = await Device_1.default.find({
        ...
        const createdVehicles = await Device_1.default.insertMany(sampleVehicles);
