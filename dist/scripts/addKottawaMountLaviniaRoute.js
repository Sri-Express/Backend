...
const addKottawaMountLaviniaRoute = async () => {
    try {
        ...
        let systemFleet = await Fleet_1.default.findOne({ companyName: 'SRI EXPRESS SYSTEM' });
        if (!systemFleet) {
            console.log('Creating system fleet...');
            systemFleet = new Fleet_1.default({
        ...
        const newRouteData = {
            ...
            approvalStatus: 'approved', // Pre-approved system route
            status: 'active',
            isActive: true,
            avgRating: 4.2,
            totalReviews: 89
        ...
        const newRoute = new Route_1.default(newRouteData);
...
exports.default = addKottawaMountLaviniaRoute;
