...
// @access  Public
router.get('/locations', weatherController_1.getAvailableLocations);
...
router.get('/current/:location', weatherController_1.getCurrentWeather);
...
router.get('/alerts/:location', weatherController_1.getWeatherAlerts);
// ================================
...
router.get('/chat/history', authMiddleware_1.protect, weatherController_1.getChatHistory);
...
router.post('/chat/save', authMiddleware_1.protect, weatherController_1.saveChatMessage);
// @desc    Get user's weather preferences
// @route   GET /api/weather/preferences
// @access  Private
router.get('/preferences', authMiddleware_1.protect, weatherController_1.getWeatherPreferences);
...
router.put('/preferences', authMiddleware_1.protect, weatherController_1.updateWeatherPreferences);
// ================================
// ADMIN ENDPOINTS
// ================================
...
router.get('/stats', authMiddleware_1.protect, adminMiddleware_1.requireAdmin, weatherController_1.getWeatherStats);
// ================================
