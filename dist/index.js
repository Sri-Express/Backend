...
const paymentRoutes_1 = __importDefault(require("./routes/paymentRoutes")); // PayHere integration routes
...
app.use('/api/fleet/vehicles', vehicleDocumentRoutes_1.default); // Vehicle document upload routes
